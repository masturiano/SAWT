...
<html lang="en">
  <head>
    ...
    <script type="text/javascript">     
                            ...
                            save: {
                                ...
                                className: "btn-success",
                                    callback: function() {   
                                        ...
                                        bootbox.confirm("Are you sure you want to edit user id #"+value+"?", function(result) {
                                            if(result == true){
                                                editingUserId(value);
                                            }
                                            else{
        ...
        // EDITING USER ID
        function editingUserId(value){
            bootbox.confirm("Are you sure you want to edit user id #"+value+"?", function(result) {
                if(result == true){
                    $.ajax({
                        url: "<?php echo base_url('systema/editing_user');?>",
                        type: "POST",
                        data: $('#edit_form').serialize()+"&id="+value,
                        success: function(){
                           bootbox.alert("Successfully edited!", function() {
            ...
            <form id="edit_form" method="POST">
                <table id="table_edit" border="0" class="table table-condensed table-striped">
                    <tr>
                        ...
                        <td class="table_data">
                            <?php echo $user_id;?>
                            <input type="hidden" class="form-control" name="txt_id" id="txt_id" value="<?php //echo $user_id; ?>"> 
                        </td>
                    </tr>
                    <?php 
                    # FETCH RESULT
                    ...
                    <tr>
                        ...
                        <td class="table_data">
                            ...
                            <input type="hidden" class="form-control" name="txt_id" id="txt_id" value="<?php echo $row2->user_id; ?>"> 
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="table_data">
                            ...
                            <input type="hidden" class="form-control" name="txt_user_name" id="txt_user_name" value="<?php echo $row2->user_name; ?>">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="table_colon"><b>:</b></td>
                        <td class="table_data">
                            <input type="text" class="form-control" name="txt_full_name" id="txt_full_name" placeholder="<?php echo $row2->full_name; ?>" 
                    ...
                    <tr>
                        ...
                        <td class="table_colon"><b>:</b></td>
                        <td class="table_data">
                            <input type="text" class="form-control" name="txt_store_code" id="txt_store_code" placeholder="<?php echo $row2->store_code; ?>" 
                    ...
                    <tr>
                        ...
                        <td class="table_colon"><b>:</b></td>
                        <td class="table_data">
                            <input type="text" class="form-control" name="txt_group_code" id="txt_group_code" placeholder="<?php echo $row2->group_code; ?>" 
                            style="height:30px; width: 100px;">  
                        </td>
                    </tr> 
                    <tr>
                        ...
                        <td class="table_colon"><b>:</b></td>
                        <td class="table_data">
                            <input type="text" class="form-control" name="txt_user_level" id="txt_user_level" placeholder="<?php echo $row2->user_level; ?>" 
                            style="height:30px; width: 100px;">  
                        </td>
                    </tr> 
                    <tr>
                        <td class="table_label"><b>User stat</b></td>
                        <td class="table_colon"><b>:</b></td>
                        <td class="table_data">
                            <input type="text" class="form-control" name="txt_user_stat" id="txt_user_stat" placeholder="<?php echo $row2->user_stat; ?>" 
                            style="height:30px; width: 100px;">  
                        </td>
                    </tr>
                    */ ?> 
