...
<html lang="en">
  <head>
    ...
    <!-- JS -->
        ...
        <!-- Foo Table 3 -->
        <script src="<? echo base_url('application/libraries/foo_table3/src/js/FooTable.js'); ?>"></script>
        
    <!-- CSS -->
        <!-- Bootstrap Minified Css -->
        <link href="<? echo base_url('application/libraries/bootstrap/css/bootstrap.min.css'); ?>" rel="stylesheet">
        <!-- Background -->
        <link href="<? echo base_url('application/libraries/background/css/styles.css'); ?>" rel="stylesheet">
        <!-- My Style CSS -->
        <link href="<? echo base_url('application/libraries/my_style.css'); ?>" rel="stylesheet">   
        <!-- Foo Table 3 -->
        <link href="<? echo base_url('application/libraries/foo_table3/src/css/FooTable.css'); ?>" rel="stylesheet">
