    ...
    <script type="text/javascript">
        ...
        function process()
        {
            ...
            if(card_typ == '0'){
                ...
                $("#cmb_card_typ").css(TextHighlightCss);
                return false;
            }
            ...
            if(date_from == ''){
                ...
                $("#datepicker_from").css(TextHighlightCss);
                return false;
            }
            else{
            ...
            if(date_to == ''){
                ...
                $("#datepicker_to").css(TextHighlightCss);
                return false;
            }
            else{
        ...
        function process3()
        {
            $.ajax
            ({
                url: '<? echo site_url('site/generate_xls');?>',
                type: 'POST',  
                data: $('#home_form').serialize(),
                beforeSend: function(data)
                {
                    $("#div_csv_message").html('Generating XLS file');
  ...
  <body onload=" checkSession(); startTime();">
    ...
    <div class="grey">
        <div class="container" align="center">
            ...
            <b>CARD TYPE :</b>
            <?php   
            $perksTnapObj->DropDownMenu($arrCardType,'cmb_card_typ','','class="selectBox ui-widget-content ui-corner-all"');
            ?>
            <b>DATE :</b>
    ...
    <div class="grey">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="well">
                        <div class="col3" id="div_csv_message">Generate XLS file</div>   
