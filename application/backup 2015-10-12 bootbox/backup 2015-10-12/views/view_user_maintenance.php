            ...
            <form id="edit_form" method="POST">
                <table id="table_edit" border="0" class="table table-condensed table-striped">
                    ...
                    <tr>
                        ...
                        <td class="table_data">
                            <?php echo "a"; ?>
                            <input type="hidden" class="form-control" name="txt_id" id="txt_id" value="<?php echo "a"; ?>"> 
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="table_colon"><b>:</b></td>
                        <td class="table_data">
                            <input type="text" class="form-control" name="txt_store_code" id="txt_store_code" placeholder="<?php echo $row->store_code; ?>" 
                    ...
                    <tr>
                        ...
                        <td class="table_colon"><b>:</b></td>
                        <td class="table_data">
                            <input type="text" class="form-control" name="txt_group_code" id="txt_group_code" placeholder="<?php echo $row->group_code; ?>" 
                            style="height:30px; width: 100px;">  
                        </td>
                    </tr> 
                    <tr>
                        ...
                        <td class="table_colon"><b>:</b></td>
                        <td class="table_data">
                            <input type="text" class="form-control" name="txt_user_level" id="txt_user_level" placeholder="<?php echo $row->user_level; ?>" 
                            style="height:30px; width: 100px;">  
                        </td>
                    </tr> 
                    <tr>
                        ...
                        <td class="table_colon"><b>:</b></td>
                        <td class="table_data">
                            <input type="text" class="form-control" name="txt_user_stat" id="txt_user_stat" placeholder="<?php echo $row->user_stat; ?>" 
                            style="height:30px; width: 100px;">  
                        </td>
                    </tr> 
                </table>    
