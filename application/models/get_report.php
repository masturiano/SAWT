...
class Get_report extends CI_Model {
    ...
    # GET NOT TRANSMIT
    function get_cancelled($oracle_username,$org_id)
    {                                                
        # FILTER USER NAME
    ...
    function get_cancelled_total($oracle_username,$org_id)
    {                                           
        # FILTER USER NAME
        $filter_user = "USER_NAME = '{$oracle_username}'"; 
    ...
    # GET NOT TRANSMIT  ALL
    function get_not_transmit_all($org_id)
    {   
    ...
    # GET NOT TRANSMIT ALL TOTAL
    function get_not_transmit_all_total($org_id)
    {   
        # FILTER NOT YET TRANSMITTED
        $transmit = "IS_TRANSMITTED is null";
    ...
    # GET NOT TRANSMIT
    function get_not_transmit($oracle_username,$org_id)
    {   
        # FILTER NOT YET TRANSMITTED
        $transmit = "IS_TRANSMITTED is null";
    ...
    # GET NOT TRANSMIT TOTAL
    function get_not_transmit_total($oracle_username,$org_id)
    {   
        # FILTER NOT YET TRANSMITTED
        $transmit = "IS_TRANSMITTED is null";
    ...
    # GET UNRECEIVE
    function get_unreceive($user_name,$org_id)
    {   
        # FILTER TRANSMITTED
    ...
    # GET UNRECEIVE TOTAL
    function get_unreceive_total($user_name,$org_id)
    {   
        # FILTER TRANSMITTED
        $transmit = "IS_TRANSMITTED = 'Y'";
    ...
    #########################( REPRINT TRANSMITTAL )#########################
    # GET REPRINT TRANSMITTAL
    function get_all_reprint_transmittal($user_name)
    {      
        # FILTER TRANSMITTED
        $transmit = "IS_TRANSMITTED = 'Y'";
        ...
        $query = "
            select 
                distinct TRANSMITTAL_NUMBER,TRANSMITTED_DATE 
            from 
                tbl_export 
            where 
                {$transmit}
                and {$filter_user}
            group by 
                TRANSMITTAL_NUMBER,TRANSMITTED_DATE
            order by 
                TRANSMITTED_DATE desc
        "; 
        $query = $this->db->query($query);
        return $query->result();   
    }
    ...
    # GET TRANSMITTAL
    function get_transmittal($transmittal_number) 
    {
        # FILTER TRANSMITTED
        $transmit = "IS_TRANSMITTED = 'Y'";    
        
        # FILTER TRANSMITTAL NUMBER
        $transmittal_num = "TRANSMITTAL_NUMBER = '{$transmittal_number}'"; 
        
        $query_get_transmittal = "
            select 
                CASH_RECEIPT_ID,RECEIPT_NUMBER,RECEIPT_DATE,ACCOUNT_NUMBER,ACCOUNT_NAME,
                ...
                IS_RECEIVED,RECEIVED_DATE,ORA_CREATION_DATE,SAWT_EXTRACT_DATE,
                IS_BIR_POSTED,BIR_POSTED_DATE,CANCELLED_DATE,TRANSMITTAL_NUMBER,FXF3,FXF4,FXF5,
                GL_DATE_SAWT,COMP_SHORT,PERIOD_FROM_DATE,PERIOD_TO_DATE
            from 
                tbl_export
            left join
        ...
        ";
        $query = $this->db->query($query_get_transmittal);
        return $query->result();
    }
