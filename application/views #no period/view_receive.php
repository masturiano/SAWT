...
<html lang="en">
  <head>
    ...
    <script type="text/javascript">     
        ...
        // ON CHANGE COMPANY DROPDOWN OF STORE
        $(function(){   
            $('#cmb_company').change(function() {
                $('#grid-data').bootgrid('reload');
                value_org_id = $(this).val();
                $.ajax({           
                    url: "<?php echo base_url('process_ho/receive_per_company');?>",
                    type: "POST",
                    data: "post_org_id="+value_org_id,
                    success: function(data){   
                        $('#div_disp_grid').html(data);         
                    }         
                });    
        ...
        // ON CHANGE COMPANY DROPDOWN OF STORE
        //$(function(){   
        //    $('#cmb_store').change(function() {
        //        $('#grid-data').bootgrid('reload');
        //        value_org_id = $('#cmb_company').val();
        //        value_store = $(this).val();
        //        if(value_org_id == 0){
        //            bootbox.alert("Please select company first!", function() {  
        ...
        //                url: "<?php echo base_url('process_ho/receive_per_company');?>",
        //                type: "POST",
        //                data: "post_org_id="+value_org_id+"&post_store="+value_store,
        //                success: function(data){   
        //                    $('#div_disp_grid').html(data);         
        //                }         
        //            });      
            ...
            <div align="center">
                ...
                <table id="table_company" border=0>
                    ...
                    <tr>
                        ...
                        <td class="table_colon">:</td>
                        <td class="table_data">
                            <select name="cmb_store" id="cmb_store"
                            style="height:30px; width: 400px;">   
                                <option value="0">SELECT STORE</option>  
                                <?php foreach($get_all_stores as $row2){ ?>
                                <option value="<?=$row2->store_num;?>"><?=$row2->store_code_name;?></option>
                                <? } ?>
                            </select> 
                        </td>
                    </tr>
