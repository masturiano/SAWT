...
class Process_ho extends CI_Controller {
            ...
            function transmit(value){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('#transmiting_confirm').click( function () {
                            $.ajax({
    ...
    public function create_textfile(){
        ...
        foreach($result_textfile as $val){
            ...
            $file_content .= trim($val['RECIEPT_NUMBER'])."|";
            $file_content .= trim($val['RECIEPT_NUMBER'])."|";
            $file_content .= trim($val['RECIEPT_NUMBER'])."|";
            $fCont .= trim($val['RECIEPT_NUMBER']);
            $fCont .= "\r\n";
            
            $destination_folder = "../../exported_file/".$file_name; 
        
            if (file_exists($destination_folder)) {
                unlink($destination_folder);
            }
            
            $handle_from_filename = fopen ($destination_folder, "x");
            
            fwrite($handle_from_filename, $file_content);
            fclose($handle_from_filename) ;
        }    
    }
