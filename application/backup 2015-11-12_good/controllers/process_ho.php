...
class Process_ho extends CI_Controller {
    ...
    public function create_textfile(){
        ...
        $file_content_header = "HSAWT,H1702Q,{$row_company->glstid},0000,\"{$row_company->comp_name}\",\"\",\"\",\"\",{$row_quarter->label_number},023";
        ...
        foreach($result_textfile as $row){     
            ...
            $file_content .= trim($row->AMOUNT).","; # 11. TAX PERCENT
            $file_content .= trim($row->TAX_BASE); # 12. TAX PERCENT
            $file_content .= "\r\n";  
        }  
