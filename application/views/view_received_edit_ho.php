  ...
  <head>
    ...
    <script type="text/javascript">     
        ...
        $(function(){       
            ...
            $.ajax({           
                url: "<?php echo base_url('process_ho/received_edit_per_company');?>",
                type: "POST",
    ...
    <div id="container">  
        ...
        <div class="modal fade" id="div_received_edit_sawt" tabindex="-1" role="dialog" aria-labelledby="div_received_edit_sawt" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Received Edit</h4>
              </div>
              <div class="modal-body">
              </div>
              <div class="modal-footer">
        ...
        <div class="modal fade" id="div_received_edit_confirm" tabindex="-1" role="dialog" aria-labelledby="div_received_edit_confirm" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-body">
              </div>
        ...
        <div class="modal fade" id="div_received_edit_save_confirm" tabindex="-1" role="dialog" aria-labelledby="div_received_edit_save_confirm" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-body">
              </div>
