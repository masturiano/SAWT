  ...
  <head>
    ...
    <script type="text/javascript">     
        ...
        function cancel(value){
            ...
            $.ajax({
                url: "<?php echo base_url('process/cancel_export');?>",
                type: "POST",
                data: "post_receipt_id="+value,
                success: function(data){
                    ...
                    $('#cancelling_confirm').click( function (e) {
                        e.stopImmediatePropagation();
                        $.ajax({
                            url: "<?php echo base_url('process/cancel_export_update');?>",
                            type: "POST",
                            data: "post_receipt_id="+value,
                            success: function(){
    ...
    <div id="container">  
        ...
        <div class="modal fade" id="div_cancel_confirm" tabindex="-1" role="dialog" aria-labelledby="div_transmit_sawt" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-body">
              </div>
              <div class="modal-footer">
                <button type="button" id="cancel_confirm_close" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" id="cancelling_confirm" class="btn btn-primary">Save</button>
              </div>
            </div>
          </div>
        </div>
