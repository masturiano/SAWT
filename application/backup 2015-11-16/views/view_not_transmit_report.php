    ...
    <script type="text/javascript">     
        ...
        function printExcel()
        {
            ...
            if($('#txt_date_from').val() == 0){
                bootbox.alert("Please select Receipt Date from!", function() {
            ...
            if($('#txt_date_to').val() == 0){
                bootbox.alert("Please select Receipt Date to!", function() {
            ...
            $.ajax
            ({
                url: '<? echo site_url('report/generate_not_transmit_xls');?>',
                type: 'POST',  
                ...
                <div class="col-lg-20">
                    <div class="well">
                        ...
                        <div align="center">   
                            ...
                            <table id="table_not_transmit_report" border=0>
                                <tr>
                                    <td class="table_label"><b>COMPANY</b></td>
