  ...
  <head>
    ...
    <script type="text/javascript">     
        ...
        $(function(){       
            ...
            $.ajax({           
                url: "<?php echo base_url('process_ho/post_per_company');?>",
                type: "POST",
        ...
        $(function(){   
            $('#cmd_company').change(function() {
                ...
                if(value == 87 || value == 85)
                    bootbox.alert("Junior and Ppci are merged!", function() {
                    return true;
                });
    ...
    <div id="loading">
        ...
        <div id="container">  
            ...
            <div class="modal fade" id="div_post_confirm" tabindex="-1" role="dialog" aria-labelledby="div_transmit_sawt" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-body">
                  </div>
                  <div class="modal-footer">
                    <button type="button" id="post_confirm_close" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" id="posting_confirm" class="btn btn-primary">Save</button>
                  </div>
                </div>
              </div>
            </div>
