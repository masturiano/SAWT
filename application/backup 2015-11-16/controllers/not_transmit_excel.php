...
class not_transmit_excel extends CI_Controller{
    ...
    function print_excel($oracle_user_name,$org_id,$date_from,$date_to){	
        ...
        $data = $this->get_report->get_not_transmit($oracle_user_name,$org_id,$date_from,$date_to);
        ...
        $data_total = $this->get_report->get_not_transmit_total($oracle_user_name,$org_id,$date_from,$date_to);
