...
class Report extends CI_Controller {
    ...
    {   
        ...
        echo "window.open('".base_url()."cancelled_excel/print_excel/".$this->session->userdata('oracleUsername')."/".$this->input->post('cmb_company')."/".$this->input->post('txt_date_from')."/".$this->input->post('txt_date_to')."');";                  
    }     
    ...
    {   
        ...
        echo "window.open('".base_url()."not_transmit_excel/print_excel/".$this->session->userdata('oracleUsername')."/".$this->input->post('cmb_company')."/".$this->input->post('txt_date_from')."/".$this->input->post('txt_date_to')."');";                  
    } 
    ...
    {   
        ...
        echo "window.open('".base_url()."unreceive_excel/print_excel/".$this->session->userdata('oracleUsername')."/".$this->input->post('cmb_company')."/".$this->input->post('txt_date_from')."/".$this->input->post('txt_date_to')."');";                  
    } 
