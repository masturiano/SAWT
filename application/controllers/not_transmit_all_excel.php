...
class not_transmit_all_excel extends CI_Controller{
    ...
    function print_excel($org_id){	
        ...
        # FILENAME
        $filename = "Not_transmit_all.xls";
        
        # SEND FILENAME
        $workbook->send($filename);
        
        # ADD WORK SHEET OR WORK SHEET LABEL
        $worksheet = &$workbook->addWorksheet('NotTransmitAll');
        ...
        # MAIN HEADER
        $worksheet->write(0,0,"NOT TRANSMIT ALL SAWT REPORT",$headerFormat);
        for($i=1;$i<12;$i++) {
        ...
        $data = $this->get_report->get_not_transmit_all($org_id);
        ...
        $data_total = $this->get_report->get_not_transmit_all_total($org_id);
